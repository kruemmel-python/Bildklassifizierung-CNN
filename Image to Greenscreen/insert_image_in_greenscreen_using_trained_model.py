...
def main():
    original_image_path: Union[str, None] = '203.jpg'  # Pfad zur Originaldatei
    background_image_path: Union[str, None] = '81.jpg'  # Pfad zur Hintergrunddatei
    output_image_path: Union[str, None] = '203g.jpg'  # Pfad zur Ausgabe
